...
export default function DashboardPage() {
  ...
  const formatExpTime = (value?: string | number): string => {
  ...
  return (
    <AnimatedPage className="px-3 lg:px-6 py-2 lg:py-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-4 mb-6 lg:mb-8">
        ...
        <MetricCard
          icon={
            <svg aria-hidden="true" className="w-4 h-4 lg:w-5 lg:h-5 text-rose-600 dark:text-rose-400" fill="currentColor" viewBox="0 0 20 20">
              <path clipRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2 2a1 1 0 001.414-1.414L11 9.586V6z" fillRule="evenodd" />
            </svg>
          }
          iconClassName="bg-rose-100 dark:bg-rose-500/20"
          title="到期时间"
          value={formatExpTime(userInfo.expTime)}
        />
      </div>
                      ...
                      >
                        <div className="space-y-3">
                          ...
                          <div className="pt-2 border-t border-gray-200 dark:border-default-200">
                            <div className="rounded-lg bg-default-50 p-2 text-center text-xs dark:bg-default-100/40">
                              <div className="text-default-500 mb-1">已用流量</div>
