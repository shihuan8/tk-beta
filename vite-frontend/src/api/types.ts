...
export interface OBSCodeAssignmentApiItem {
  userId: number;
  userName: string;
  pushCode: string;
  inputCode: string;
...
export interface UserBalanceApiItem {
  userId: number;
  balance: number;
  updatedTime: number;
}

export interface UserPlanApiItem {
  id: number;
  userId: number;
  planId: number;
  planName?: string;
...
export interface BalanceWithUserApiItem {
  userId: number;
  balance: number;
  updatedTime: number;
  userName: string;
...
export interface BalanceLogApiItem {
  id: number;
  userId: number;
  userName: string;
  amount: number;
...
export interface PaymentConfigApiItem {
  id: number;
  channel: "USDT" | "YIPAY" | string;
  config: string;
  enabled: number;
  createdAt: number;
  updatedAt: number;
...
export interface PaymentStatsApiData {
  paidAmount: number;
  paidOrders: number;
