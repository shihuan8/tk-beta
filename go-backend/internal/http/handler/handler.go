...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/user/package-permissions", h.userPackagePermissions)
	...
	mux.HandleFunc("/api/v1/tunnel/user/assign-package-group", h.userTunnelAssignPackageGroup)
	...
	mux.HandleFunc("/api/v1/plan/list", h.planList)
	mux.HandleFunc("/api/v1/plan/create", h.planCreate)
	mux.HandleFunc("/api/v1/plan/update", h.planUpdate)
	mux.HandleFunc("/api/v1/plan/delete", h.planDelete)
	mux.HandleFunc("/api/v1/plan/available", h.planAvailable)
	mux.HandleFunc("/api/v1/plan/purchase", h.planPurchase)
	mux.HandleFunc("/api/v1/plan/store-status", h.getStoreStatus)
	mux.HandleFunc("/api/v1/plan/store-status/save", h.setStoreStatus)
	mux.HandleFunc("/api/v1/package/auto-buy-traffic/list", h.listAutoBuyTrafficPackages)
	mux.HandleFunc("/api/v1/user/plan/list", h.userPlanList)
	mux.HandleFunc("/api/v1/user/balance", h.userBalance)
	mux.HandleFunc("/api/v1/balance/set", h.balanceSet)
	mux.HandleFunc("/api/v1/balance/list", h.balanceList)
	mux.HandleFunc("/api/v1/balance/logs", h.balanceLogList)
	mux.HandleFunc("/api/v1/balance/log/delete", h.balanceLogDelete)
	mux.HandleFunc("/api/v1/balance/log/cleanup", h.balanceLogCleanup)
	...
	mux.HandleFunc("/api/v1/order/admin/list", h.adminOrderList)
	mux.HandleFunc("/api/v1/order/admin/update", h.adminOrderUpdate)
	mux.HandleFunc("/api/v1/order/admin/delete", h.adminOrderDelete)
	mux.HandleFunc("/api/v1/order/admin/refund", h.adminOrderRefund)
	mux.HandleFunc("/api/v1/order/list", h.userOrderList)
	mux.HandleFunc("/api/v1/obs-code/list", h.obsCodeList)
	mux.HandleFunc("/api/v1/obs-code/mine", h.obsCodeMine)
	mux.HandleFunc("/api/v1/obs-code/save", h.obsCodeSave)
	mux.HandleFunc("/api/v1/obs-code/delete", h.obsCodeDelete)
