...
type TunnelGroup struct {
	...
	SpeedLimit  int64  `gorm:"column:speed_limit;not null;default:0" json:"speedLimit"`
	CreatedTime int64  `gorm:"column:created_time;not null"`
	UpdatedTime int64  `gorm:"column:updated_time;not null"`
	Status      int    `gorm:"not null"`
}
...
type UserGroup struct {
	...
	FlowLimit    int64  `gorm:"column:flow_limit;not null;default:0" json:"flowLimit"`
	SpeedLimit   int64  `gorm:"column:speed_limit;not null;default:0" json:"speedLimit"`
	RuleQuota    int    `gorm:"column:rule_quota;not null;default:0" json:"ruleQuota"`
	DurationDays int    `gorm:"column:duration_days;not null;default:0" json:"durationDays"`
	CreatedTime  int64  `gorm:"column:created_time;not null"`
	UpdatedTime  int64  `gorm:"column:updated_time;not null"`
	Status       int    `gorm:"not null"`
}
...
type Plan struct {
	...
	TrafficQuota   int64   `gorm:"column:traffic_quota;not null;default:0" json:"trafficQuota"`
	SpeedLimit     int64   `gorm:"column:speed_limit;not null;default:0" json:"speedLimit"`
	RuleQuota      int     `gorm:"column:rule_quota;not null;default:0" json:"ruleQuota"`
	DurationDays   int     `gorm:"column:duration_days;not null;default:0" json:"durationDays"`
	UserGroupID    int64   `gorm:"column:user_group_id;not null;default:0" json:"userGroupId"`
	TunnelGroupIDs []int64 `gorm:"-" json:"tunnelGroupIds,omitempty"`
...
type PlanTunnelGroup struct {
	PlanID        int64 `gorm:"column:plan_id;primaryKey"`
	TunnelGroupID int64 `gorm:"column:tunnel_group_id;primaryKey"`
}

func (PlanTunnelGroup) TableName() string { return "plan_tunnel_group" }
...
type UserPlan struct {
	...
	PlanID      int64 `gorm:"column:plan_id;not null" json:"planId"`
	StartTime   int64 `gorm:"column:start_time;not null" json:"startTime"`
	EndTime     int64 `gorm:"column:end_time;not null" json:"endTime"`
	Status      int   `gorm:"not null;default:1" json:"status"`
	TrafficUsed int64 `gorm:"column:traffic_used;not null;default:0" json:"trafficUsed"`
	CreatedTime int64 `gorm:"column:created_time;not null" json:"createdTime"`
}

func (UserPlan) TableName() string { return "user_plan" }
...
type Order struct {
	...
	PayCurrency string `gorm:"column:pay_currency;type:varchar(20);not null;default:'BALANCE'" json:"payCurrency"`
	Status      int    `gorm:"not null;default:0" json:"status"`
	PayTime     int64  `gorm:"column:pay_time;not null;default:0" json:"payTime"`
	PayURL      string `gorm:"column:pay_url;type:varchar(512);not null;default:''" json:"payUrl"`
	PayAddress  string `gorm:"column:pay_address;type:varchar(100);not null;default:''" json:"payAddress"`
	TxHash      string `gorm:"column:tx_hash;type:varchar(100);not null;default:''" json:"txHash"`
...
type BalanceLog struct {
	...
	BalanceBefore float64 `gorm:"column:balance_before;not null;default:0" json:"balanceBefore"`
	BalanceAfter  float64 `gorm:"column:balance_after;not null;default:0" json:"balanceAfter"`
	Reason        string  `gorm:"type:varchar(200);not null" json:"reason"`
	CreatedTime   int64   `gorm:"column:created_time;not null" json:"createdTime"`
	Signature     string  `gorm:"type:varchar(128);not null;default:'1'" json:"signature"`
}
...
type PaymentConfig struct {
	ID        int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	Channel   string `gorm:"type:varchar(20);not null;uniqueIndex" json:"channel"`
	Config    string `gorm:"type:text;not null" json:"config"`
	Enabled   int    `gorm:"not null;default:0" json:"enabled"`
	CreatedAt int64  `gorm:"column:created_at;not null" json:"createdAt"`
	UpdatedAt int64  `gorm:"column:updated_at;not null" json:"updatedAt"`
}
...
type UserQuotaHistory struct {
	ID            int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	UserID        int64  `gorm:"column:user_id;not null;index" json:"userId"`
	ResetTime     int64  `gorm:"column:reset_time;not null" json:"resetTime"`
	InFlowBefore  int64  `gorm:"column:in_flow_before;not null;default:0" json:"inFlowBefore"`
	OutFlowBefore int64  `gorm:"column:out_flow_before;not null;default:0" json:"outFlowBefore"`
	UsedBytes     int64  `gorm:"column:used_bytes;not null;default:0" json:"usedBytes"`
	ResetReason   string `gorm:"column:reset_reason;type:varchar(200);not null;default:''" json:"resetReason"`
	CreatedTime   int64  `gorm:"column:created_time;not null" json:"createdTime"`
}
...
type OBSCodeAssignment struct {
	UserID      int64  `gorm:"column:user_id;primaryKey" json:"userId"`
	UserName    string `gorm:"column:user_name;type:varchar(100);not null" json:"userName"`
	PushCode    string `gorm:"column:push_code;type:text;not null" json:"pushCode"`
	InputCode   string `gorm:"column:input_code;type:text;not null" json:"inputCode"`
	Remark      string `gorm:"type:text" json:"remark"`
	UpdatedTime int64  `gorm:"column:updated_time;not null" json:"updatedTime"`
}

func (OBSCodeAssignment) TableName() string { return "obs_code_assignment" }
